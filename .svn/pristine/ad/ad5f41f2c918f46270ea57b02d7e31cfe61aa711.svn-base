    ...
    <jsp:param name="menu" value="online" />
      ...
      <div id="matter_section">
        ...
        <!--.search_area--></div>
      	...
      	<div class="btn_list">
            <ul class="clearfix">
              <li><button type="button" class="btn btn-default red" onclick="updateGoodsStatus('${pageContext.request.contextPath}/supplier/goodsOnline/updateGoodsStatus','1')">上架</button></li>
              <li><button type="button" class="btn btn-default red" onclick="updateGoodsStatus('${pageContext.request.contextPath}/supplier/goodsOnline/updateGoodsStatus','0')">下架</button></li>
