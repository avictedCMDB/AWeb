...
public class Invoice {
    ...
    private String invoiceReceiveDetail;
    ...
    public String getInvoiceReceiveDetail() {
        return invoiceReceiveDetail;
    }
    
    public void setInvoiceReceiveDetail(String invoiceReceiveDetail) {
        this.invoiceReceiveDetail = invoiceReceiveDetail;
    }
