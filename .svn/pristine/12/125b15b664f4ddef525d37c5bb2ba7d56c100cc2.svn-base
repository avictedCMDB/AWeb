...
public class GoodsToCompare implements Serializable{
	...
	private String chooseGoodsIndex;
	private List<String> checkedReasonList = new ArrayList<String>();
	
	private String returnUrl; 		 //转发的url
	
	
	public String getChooseGoodsIndex() {
		return chooseGoodsIndex;
	}
	public void setChooseGoodsIndex(String chooseGoodsIndex) {
		this.chooseGoodsIndex = chooseGoodsIndex;
	}
	...
	public void setProCheckedReason(String proCheckedReason) {
		ProCheckedReason = proCheckedReason;
	}
