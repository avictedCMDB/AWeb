...
<link href="${pageContext.request.contextPath}/static/css/supervise_jingjia.css" rel="stylesheet"/>
...
var CONTEXT = "${pageContext.request.contextPath}";
	...
	function querySup(action,page){
		if (action == null) {
			action = CONTEXT+'/supervise/partner/querySup';
		}
		$.ajax({
    ...
    <div class="inner">
      ...
      <div id="matter_section">
        ...
        <form id="queryForm">
          ...
          <div class="btn_list">
            <ul>
              <li><button type="button" class="btn btn-default red" onclick="query('${pageContext.request.contextPath}/supervise/partner')">查询</button></li>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body clearfix">
                  <div class="form-group clearfix">
                    ...
                    <div class="input_area">
                      ...
                      <button class="btn btn-default blue" onclick="querySup('${pageContext.request.contextPath}/supervise/partner/querySup',1)">查询</button>
                    </div>
                  </div>
							...
							<div class="page">
								...
								<c:forEach varStatus="i" begin="1" end="${supPages}" step="1">
									...
									<c:choose>
										...
										<c:otherwise>
											<li>
										<a href="javascript:void(0);" onclick="querySup('${pageContext.request.contextPath}/supervise/partner/querySup',${idx})">${idx}</a>
									</li>
										</c:otherwise>
									</c:choose>
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-default red" onclick="insertPartener('${pageContext.request.contextPath}/supervise/partner/insertPartener')">确定</button>
        ...
        <div class="search_result section">
          <table border="0">
            ...
            <tr>
            		<td class="left-list">${enterpriseSupMapping.companyName}</td>
               		...
               		<td>
						<c:choose>
	              		<c:when test="${enterpriseSupMapping.ifBuilding == 0}">
	              			<a href="javascript:void(0);" onclick="updateIfBuilding('${pageContext.request.contextPath}/supervise/partner/updateIfBuilding','${enterpriseSupMapping.id}','1')">解除合作</a>
	              		</c:when>
	              		<c:otherwise>
	              			<a href="javascript:void(0);" onclick="updateIfBuilding('${pageContext.request.contextPath}/supervise/partner/updateIfBuilding','${enterpriseSupMapping.id}','0')">恢复合作</a>
	              		</c:otherwise>
	              	</c:choose>
	              		<a href="javascript:void(0);" onclick="deleteSupMapping('${pageContext.request.contextPath}/supervise/partner/deleteSupMapping','${enterpriseSupMapping.id}')"> 删除</a>
					</td>
					 </tr>
            </c:forEach>
          </table>
