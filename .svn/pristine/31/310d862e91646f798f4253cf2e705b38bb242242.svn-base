      ...
      <div id="matter_section">
        <div id="step">
          <ul class="image_list clearfix">
            <li><a href="${pageContext.request.contextPath}/supplier/companyMyInfo"><span class="num">1</span><span class="text">完善企业基本信息</span></a></li>
        ...
        <!-- .section --></div>
        <div class="btn_area">
          <button class="btn btn-default gray" type="button" onclick="window.location.href='${pageContext.request.contextPath}/supplier/companyMyInfo'">返回上一步</button>
