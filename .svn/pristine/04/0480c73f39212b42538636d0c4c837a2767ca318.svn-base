      ...
      <div id="matter_section">
          ...
          <div class="input_area">
            ...
            <div class="yes_area" id="yesArea">
              <dl class="clearfix">
                ...
                <dd><input type="text" class="form-control" maxlength="50" placeholder="统一社会信用代码" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="socialCreditCode" name="socialCreditCode" value="${companyMyInfo.socialCreditCode}"><!-- <span class="red remind">统一社会信用代码</span> --></dd>
              </dl>
              <dl class="clearfix">
                <dt><span class="red">*</span>注册资金</dt>
                <dd>
                  <div class="money_input"><input type="text" class="form-control" maxlength="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="regFund1" name="regFund1" value="${companyMyInfo.regFund}"></div>
                  <div class="unit">
            ...
            <div class="no_area" id="noArea" style="display:none;">
              <div class="paper clearfix">
                <dl class="clearfix">
                  ...
                  <dd><input type="text" class="form-control" maxlength="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="organizationCode" name="organizationCode" value="${companyMyInfo.organizationCode}"></dd>
                </dl>
                <dl class="clearfix">
              ...
              <div class="paper clearfix">
                <dl class="clearfix">
                  ...
                  <dd><input type="text" class="form-control" max="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="licenceCode" name="licenceCode" value="${companyMyInfo.licenceCode}"></dd>
                </dl>
                <dl class="clearfix">
                  <dt><span class="red">*</span>注册资金</dt>
                  <dd>
                    <div class="money_input"><input type="text" class="form-control" maxlength="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="regFund2" name="regFund2" value="${companyMyInfo.regFund}"></div>
                    <div class="unit">
              ...
              <div class="paper clearfix paper_last">
                <dl class="clearfix">
                  ...
                  <dd><input type="text" class="form-control" maxlength="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="taxCode" name="taxCode" value="${companyMyInfo.taxCode}"></dd>
                </dl>
                <dl class="clearfix">
        ...
        <div class="section_inner clearfix section_step">
          ...
          <div class="input_area">
            <dl class="clearfix">
              <dt>资信等级</dt>
              <dd><input type="text" class="form-control" maxlength="100" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="quLevel" name="quLevel" value="${companyMyInfo.quLevel}"></dd>
            </dl>
            <dl class="clearfix">
              <dt>资信证书颁发单位</dt>
        ...
        <!-- .section --></div>
        <div class="btn_area">
          <button class="btn btn-default gray" type="button" onclick="window.location.href='${pageContext.request.contextPath}/management/companyMyInfo'">返回上一步</button>
          <button class="btn btn-default blue" type="button" onclick = "saveManagementMyInfo();">保存并提交审核</button>
        </div>
      </div>
     </form>
    </div>
