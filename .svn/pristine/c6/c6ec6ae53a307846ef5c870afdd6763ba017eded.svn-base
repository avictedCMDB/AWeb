...
public class DataCache {
    ...
    */
    ...
    public String getSupplierName(int sup) {
        return supplierMapper.querySupplierById(sup).getSupName();//SUPPLIER_MAP.get(sup);
    }
    
    public List<Supplier> getSupplierList() {
        return supplierMapper.querySupplierList();//SUPPLIER_LIST;
    }
    
    public Supplier getSupplier(int sup) {
        /*
        for (Supplier i : SUPPLIER_LIST) {
            if (i.getSupId() == sup) {
                return i;
        ...
        */
        ...
        return supplierMapper.querySupplierById(sup);
    }
    
    public int getSysCatId(int sup, int cat) {
        if (!CATEGORY_REL.containsKey(sup + "-" + cat)) {
            return 0;
        }
