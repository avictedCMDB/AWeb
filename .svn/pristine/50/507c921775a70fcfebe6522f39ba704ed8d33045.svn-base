...
public class AlipayNotify {
     ...
     * @return 验证结果
     */
    public static boolean verify(Map<String, String> params,String partner,String sign_type,String alipay_public_key,String input_charset) {
    ...
    */
    private static String verifyResponse(String notify_id,String part) {
