  ...
  <div id="contents">
    <div class="inner">
      ...
      <div id="matter_section">
          ...
          <ul>
            <li><button type="button" class="btn btn-default red" onclick="window.location.href = '${pageContext.request.contextPath}/management/invoice/addInvoicePage'">新增发票</button></li>
          </ul>
        <!--.search_area--></div>
      	<div class="search_result">
          <table border="0">
          	<tr>
              <th width="205">付款单位名称</th>
              <th width="225">纳税人识别号</th>
              <th width="205">发票内容</th>
              <th>是否默认</th>
              <th width="170">操作</th>
            </tr>
           <c:forEach var="invoice" items="${invoices}" varStatus="status">
            <tr>
              ...
              <td>
              	...
              	<a href="javascript:void(0);" onclick="deleteInv('${pageContext.request.contextPath}/management/invoice/delete/${invoice.invoiceID}')">删除</a>
