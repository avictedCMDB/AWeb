					...
					<div id="slider" class="carousel slide">
						...
						<div class="carousel-inner">
							<div class="item active">
								<a href="${pageContext.request.contextPath}/market/campaign/aug"><img src="${pageContext.request.contextPath}/static/img/index_top/campaign_aug.jpg" alt="First slide"></a>
							</div>
							<div class="item">
						...
						<div id="bid_content" class="tab-content">
								...
								<div class="tab_inner">
									...
									<c:forEach varStatus="sta" var="i" items="${notices }">
										<li class="clearfix">
	                      				...
	                      				<c:choose>
	                      					<c:when test="${i.projId eq 'ZB-20170802-115608'}">
	                      						<div class="btn_detail"><a href="${pageContext.request.contextPath}/market/bid/notice/downloadSpecialFile?specialAttachmentPath=" target="_blank" class="btn btn-default blue">查看详情</a></div>
	                      					</c:when>
	                      					<c:otherwise>
							...
							<div class="tab-pane fade" id="bid_result">
								<div class="tab_inner">
									...
									<li class="clearfix">
											<div class="text_area">
												<p><span class="red">【结果】</span>中航泰德（深圳）海洋工程有限公司通风等生产设备及闲置办公设备竞买公告</p>
												<p class="time">发布时间：<span>2017-08-04</span></p>
											</div>
											<div class="btn_detail"><a href="${pageContext.request.contextPath}/market/bid/result/downloadSpecialFile?specialAttachmentPath=" target="_blank" class="btn btn-default blue">定标通知书</a></div>
									</li>
