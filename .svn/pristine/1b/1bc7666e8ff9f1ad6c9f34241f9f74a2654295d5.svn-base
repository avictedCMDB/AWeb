...
public interface BidProjectService {
    ...
    public List<BidProject> queryProjectList(String userId, String projId, String projName, String bidCat, String createTime, List<String> status, int order, int page, int size);
