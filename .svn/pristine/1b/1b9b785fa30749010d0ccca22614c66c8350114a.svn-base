          ...
          <div id="matter_section">
              ...
              <div class="signo clearfix">
                ...
                <div class="signo03 clearfix">
                 ...
                 <ul>
                    <li><button class="btn btn-default blue" onclick="window.open('${pageContext.request.contextPath}/management/bid/contract/word?projId=${proj.projId }&supCode=${sup.supCode }');">导出word</button></li>
