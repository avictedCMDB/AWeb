...
public class OrderRefoundBean implements Serializable {
	...
	private	String	buy_num	;	//	退货数量
	private	String	refound_reason	;	//	换货原因
	private	String	refound_id	;	//	换货编码
	private	String	refound_amount	;	//	换货总数量
	private	String	refound_price	;	//	换货总金额
	...
	private String  refound_price_init;//换货金额（初始）
