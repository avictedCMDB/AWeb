					...
					<c:if test="${!empty hot}">
                       ...
                       <div id="menu_cate">
						...
						<div id="contact_main">
							...
							<div class="brands clearfix">
								<div class="sl_key special_ksy">价格</div>	
								<div class="sl_value clearfix">
									<ul>
	                                ...
	                                <div class="sl_key special_ksy" style="margin-top:5px;"><button type="button" class="btn btn-default add_btn" data-link="${pageContext.request.contextPath}/market/goods/search?q=${fn:escapeXml(searchKeyword)}&cat=${cat}&brand=${fn:escapeXml(searchBrand)}&sup=${sup}&o=${order}&view=${view}" id="filter_btn">搜索</button></div>
