...
public class BidProjectServiceImpl implements BidProjectService {
    ...
    @Override
    public int queryProjectCount(String userId, String projId, String projName, String bidCat, String createTime, List<String> status) {
        return bidProjectMapper.queryProjectCount(userId, projId, projName, bidCat, createTime, status);
    }
    ...
    public List<BidProject> queryProjectList(String userId, String projId, String projName, String bidCat, String createTime, List<String> status, int order,
        ...
        int start = (page - 1) * size + 1;
        int end  = start + size - 1;
        return bidProjectMapper.queryProjectList(userId, projId, projName, bidCat, createTime, status, order, start, end);
    }
    ...
    public BidProject queryProjectDetail(String projId) {
        ...
        if (proj != null) {
            proj.setMateriels(bidProjMaterielMapper.queryAllByProj(projId));
