		...
		if(xmlhttp.readyState == 4){
			if(xmlhttp.status == 200){
				...
				if (temp > 0){
					...
					var imgHtml = "<li id='imgli_"+imgSort+"'><a class='preview' id='imgUpload_"+imgSort+"' href='"+actionPath+imgPath+"'><img src='"+actionPath+imgPath+"'></a><a href='javascript:void(0);' onclick='deleteImg("+imgSort+");'><img src='"+actionPath+"/static/img/icon-close_blue.png' /></a></li>";
