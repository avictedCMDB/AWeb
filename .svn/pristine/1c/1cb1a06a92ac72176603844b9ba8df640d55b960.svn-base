...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/supervisecompare.js"></script>
</head>
<body>
<div class="page-wrapper">
  ...
  <input id="path" type="hidden" value="${pageContext.request.contextPath}">
    <div class="inner">
      ...
      <form id="managementCompareForm" action="/AWeb/supervise/compare" method="post">
        ...
        <!--.search_area--></div>
          ...
          <table border="0">
            ...
            <tr>
              ...
              <td><a href="javascript:void(0);" onclick="updateProductCompare('${productCompare.compareID}');">导出PDF</a></td>
            </tr>
            </c:forEach>
          </table>
        <!--.search_result--></div>
