    ...
    <div class="inner">
      ...
      <div id="matter_section">
          ...
          <div class="search_result">
            ...
            <table class="table_area">
              ...
              <c:if test="${action == 'award' and (proj.projStatus == 4 or proj.projStatus == 8)}">
                ...
                <th width="130">节支金额</th>
                <th width="120">折扣率</th>
                <th width="120">报价详情</th>
                <th class="last" width="120">报价历史</th>
              </tr>
              ...
              <c:if test="${action == 'award' and proj.projStatus == 8}">
                ...
                <c:if test="${statusItem.index == 0}">
                	<td rowspan="${fn:length(sups)}"><a href="javascript:;" class="quota-detail" data-sup="all">查看</a></td>
                </c:if>
              </tr>
              </c:forEach>
            </table>
              ...
              <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <table class="table_area">
                                <tr>
                                  <th style="display:none" id="supTh">供应商</th>
                                  <th>报价</th>
          ...
          <c:if test="${action == 'view' and proj.projStatus == 5}">
                  ...
                  <li><a target="_blank" href="${pageContext.request.contextPath}/supervise/bid/project/print?projId=${proj.projId}" class="btn btn-default blue">查看报价详情</a></li>
