      ...
      <div id="matter_section">
        ...
        <div class="search_result">
          <div class="state_list">
            ...
            <a href="${pageContext.request.contextPath}/supervise/invoice/export?timeStart=${timeStart}&timeEnd=${timeEnd}&orderId=${orderId}&companyId=${companyId}&invoiceStatus=${invoiceStatus}" class="btn btn-default red" target="_blank" id="export_btn" type="button">导出</a>
          </div>
          <div class="state_list">
          ...
          <table>
            ...
            <tr>
              ...
              <c:if test="${item.refunding == 0}">
	              ...
	              <a href="javascript:void(0);" onclick="doNoInvoice('${item.orderId}')">不开票</a>
	              </c:if>
