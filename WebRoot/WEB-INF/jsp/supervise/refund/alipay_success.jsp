    ...
    <div class="inner">
      <div id="payment_details">
        ...
        <div class="section_details btn_list">
          <ul>
            <li><button type="button" class="btn btn-default red" onclick="window.location.href='${pageContext.request.contextPath}/supervise/refund/list'">返回退货退款列表</button></li>
          </ul>
        </div>
      <!--.order_details--></div>
