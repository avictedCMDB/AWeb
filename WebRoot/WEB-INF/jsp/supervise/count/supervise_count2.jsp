  ...
  <div id="contents">
    <div class="inner">
      ...
      <div id="matter_section">
        ...
        <div class="btn_list">
            <ul>
              <li><button type="button" class="btn btn-default red" onclick="loadCompanyChart();">查询</button></li>
              <li><button type="button" class="btn btn-default gray" onclick="clear2();">清空</button></li>
            </ul>
          </div>
