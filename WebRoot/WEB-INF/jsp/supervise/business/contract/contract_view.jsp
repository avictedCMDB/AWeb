  ...
  <div id="contents">
      <div class="inner">
          <div id="matter_section">
              ...
              <div class="summary">
                <p><span class="border_bottom">${proj.purchaserName }</span>（以下简称“甲方”）与 <span class="border_bottom">${sup.supName }</span>（以下简称“乙方”）在平等、自愿、公平、诚实信用之基础上，就甲方<span class="border_bottom">${proj.projName }</span>项目（项目编号<span class="border_bottom">${proj.projId}</span>）向乙方采购<span class="border_bottom">${subs }</span>事宜，经友好协商一致，订立本合同，以资共同信守。</p>
              </div>
              ...
              <div class="signo clearfix">
                ...
                <div class="signo03 clearfix">
                 ...
                 <ul>
                    <li><button class="btn btn-default blue" onclick="window.open('${pageContext.request.contextPath}/supervise/contract/word?projId=${proj.projId }&busi_type=${busi_type}');">导出word</button></li>
