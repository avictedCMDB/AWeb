...
<div class="page-wrapper">
  ...
  <div id="contents">
    <div class="inner clearfix">
      ...
      <div class="login_box">
        <h2><img src="${pageContext.request.contextPath}/static/img/login/title-login_cgr.png" alt="用户登录" /></h2>
        <div class="login_inner">
          <div class="inner_bottom">
			<form action="${pageContext.request.contextPath}/passport/login/submit" method="post" id="login_form">
                ...
                <div class="forget clearfix"><p><a href="${pageContext.request.contextPath}/market/register/findPassword?userType=1">忘记密码？</a><a class="register" href="${pageContext.request.contextPath}/market/register">立即注册</a></p></div>
				<div class="btn_area">
