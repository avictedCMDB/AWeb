        ...
        <!--.search_area--></div>
          ...
          <table border="0">
            <tr>
              ...
              <th width="70">购买数量</th>
              <th width="80">询价前单价</th>
              <th width="80">询价后单价</th>
            ...
            <tr>
              ...
              <td>
              	<c:if test="${supplierGoodsEnquiry.enquiryStatus == '1' or supplierGoodsEnquiry.enquiryStatus == '2'}">报价 拒绝</c:if>
              	...
              	<a href="javascript:void(0)" onclick="updateNoEnquiryStatus('${pageContext.request.contextPath}/supplier/goodsEnquiry/updateGoodsEnquiry','${supplierGoodsEnquiry.id}')">拒绝</a>
				</c:if>
