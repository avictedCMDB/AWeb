...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
  ...
  <div id="copy_right">
    <div class="inner">
     <p><img src="${pageContext.request.contextPath}/static/img/beian.png" /><a class="beian" target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010502030831">京公网安11010502030831号</a><a class="beian" target="_blank" href="http://www.miibeian.gov.cn">京ICP备05012983</a></p>
    </div>
  </div>
<!--.page-wrapper-->