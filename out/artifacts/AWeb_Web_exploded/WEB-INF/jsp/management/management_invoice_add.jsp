    ...
    <div class="inner details">
      ...
      <div id="info_invoice">
	      ...
	      <form class="form-horizontal" action="" method="post" id="editInvoiceForm">
		      ...
		      <input id="invoiceFlag" name="invoiceFlag" type="hidden" value="${invoice.invoiceFlag}">
	          <div class="form-group clearfix">
	            <label for="name" class="control-label">纳税人识别号:</label>
	            <input type="text" class="form-control detail" maxlength="32" id="invoiceNum" name="invoiceNum" value="${invoice.invoiceNum}">
	            <input type="hidden" class="form-control detail" maxlength="32" id="invoiceNum" name="oldInvoiceNum" value="${invoice.invoiceNum}">
	          </div>		      
	      	  <div class="form-group clearfix">
	            <label for="name" class="control-label">发票抬头:</label>
	            <input type="text" class="form-control detail" maxlength="32" id="companyName" name="companyName" value="${invoice.companyName}">
	            <input type="hidden" class="form-control detail"  name="oldCompanyName" value="${invoice.companyName}">
	          </div>
	          <div class="form-group clearfix">
	            ...
	            <div class="list_section invoice_list detail clearfix">
	              <ul class="clearfix" id="invoiceContentUL">
	                <li><a href="javascript:void(0);" id="invoiceContent0" <c:if test="${invoice.invoiceFlag == '0'}"> class="active"</c:if> onclick="chooseInvoiceFlg(0);">明细</a></li>
	        ...
	        <div class="btn_add btn_middle">
	          <ul>
	            <li><button  type="button" class="btn btn-default blue" onclick="saveInvoice('${pageContext.request.contextPath}');">保存发票信息</button></li>
	            <li><button  type="button" class="btn btn-default gray" onclick="window.location.href = '${pageContext.request.contextPath}/management/invoice'">取消</button></li>
	          </ul>
	        </div>
        </div>
      </div>
