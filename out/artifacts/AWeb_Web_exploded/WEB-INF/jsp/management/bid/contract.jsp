		...
		if (result.data) {
            ...
            */
          	...
          	for (var i = 0; i < result.data.length; i++) {
	            ...
	            tr.append("<td>" + (new Date(item.bidStartTime).asString("yyyy-mm-dd hh:min:ss")) + "</td>");
	            ...
	            var op = $("<td>");
	            if (item.contractStatus == 1) {
	            	op.append("<a href='${pageContext.request.contextPath}/management/bid/contract/gen?projId=" + item.projId + "&supCode=" + item.supCode + "'>生成电子合同</a>");
	            } else if (item.contractStatus == 2) {
	            	op.append("<a href='${pageContext.request.contextPath}/management/bid/contract/audit?projId=" + item.projId + "&supCode=" + item.supCode + "'>审核</a>");
	            } else if (item.contractStatus == 3) {
	            	op.append("<a href='${pageContext.request.contextPath}/management/bid/contract/view?projId=" + item.projId + "&supCode=" + item.supCode + "' target='_blank'>浏览合同</a>");
	            	op.append("<a href='${pageContext.request.contextPath}/management/bid/project/notice?projId=" + item.projId + "'>定标通知书</a>");
	            } else {
	            	op.append("<a href='${pageContext.request.contextPath}/management/bid/contract/detail?projId=" + item.projId + "&supCode=" + item.supCode + "'>查看</a>");
	            }
              ...
              <div class="list_inner clearfix">
                  <div class="form-group">
                     ...
                     <div class="input_area">
                       <input type="text" class="form-control" id="proj_id" value="${projId }">
                     </div>
                  </div>
                  <div class="form-group">
