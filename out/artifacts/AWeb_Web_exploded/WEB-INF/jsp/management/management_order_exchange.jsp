      ...
      <div class="search_result">
      	<table>
   			<tr>
    			...
    			<th width="120" style="display: none;">换货原价金额(元)hidden</th>
   			...
   			<tr class="company">
    			<td colspan="9"><label>换货总数量：</label><span id='hhzsl'>0</span><label>换货总金额：</label><span id='hhzje'>0.00</span><span id='hhzje_o' style="display: none;">0.00</span></td>
   			</tr>
	    	</table>
