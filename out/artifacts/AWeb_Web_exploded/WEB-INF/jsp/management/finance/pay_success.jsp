    ...
    <div class="inner">
      <div id="payment_details">
        ...
        <div class="section_details btn_list">
          <ul>
            <li><button type="button" class="btn btn-default red" onclick="window.location.href='${pageContext.request.contextPath}/management/finance/list?orderStatus=2'">返回支付列表</button></li>
          </ul>
        </div>
      <!--.order_details--></div>
