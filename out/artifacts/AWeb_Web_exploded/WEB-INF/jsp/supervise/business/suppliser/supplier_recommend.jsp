	              ...
	              <c:choose>
	                <c:when  test="${supplierRecommend.ifRecommend == 1}">
	                	<td width="90" class="last">
	                		<a href="javascript:void(0);" onclick="setRecommendPage(${supplierRecommend.supID});">推荐</a><!-- |
	                		<a href="javascript:void(0);" onclick="showCompany('${supplierRecommend.supID}')">查看合作单位</a> -->
	                	</td>
	                </c:when>
	              	<c:otherwise>
	              		<td width="90" class="last">
	              			<a href="javascript:void(0);" onclick="cancleRecommend(${supplierRecommend.supID});">取消推荐</a><!--|
	              			<a href="javascript:void(0);" onclick="showCompany('${supplierRecommend.supID}')">查看合作单位</a>-->
	              		</td>
	              	</c:otherwise>
	              </c:choose>
