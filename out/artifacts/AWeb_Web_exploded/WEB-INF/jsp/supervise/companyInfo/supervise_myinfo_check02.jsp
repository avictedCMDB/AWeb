      ...
      <div id="matter_section">
          ...
          <div class="input_area">
            <dl class="clearfix">
              ...
              <dd class="role_area">
                <label class="checkbox-inline">
                  <input type="radio" disabled="disabled" name="optionsRadiosinline" value="1" <c:if test="${empty companyMyInfo.ifCreditCode || companyMyInfo.ifCreditCode == '1'}">checked="checked"</c:if>  onchange="changeRadio(this)"/>是
                </label>
                <label class="checkbox-inline">
                  <input type="radio" disabled="disabled" name="optionsRadiosinline" value="2"<c:if test="${companyMyInfo.ifCreditCode == '2'}">checked="checked"</c:if> onchange="changeRadio(this)"/>否
                </label>
              </dd>
            </dl>
            <!-- 选择是显示的内容 -->
            <div class="yes_area" id="yesArea">
              <dl class="clearfix">
                ...
                <dd><input type="text" readonly="readonly" class="form-control" maxlength="50" placeholder="统一社会信用代码" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="socialCreditCode" name="socialCreditCode" value="${companyMyInfo.socialCreditCode}"><!-- <span class="red remind">统一社会信用代码</span> --></dd>
              </dl>
              <dl class="clearfix">
                <dt><span class="red">*</span>注册资金</dt>
                <dd>
                  <div class="money_input"><input type="text" readonly="readonly" class="form-control" maxlength="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="regFund1" name="regFund1" value="${companyMyInfo.regFund}"></div>
                  <div class="unit">
                    <select class="form-control" id="yuan1" name="yuan1" disabled="disabled">
                      <option value="1">元</option>
                      <!-- <option value="2">万元</option> -->
                    </select>
                  </div>
                  <div class="unit">
                    <select class="form-control" id="ut1" disabled="disabled">
                  ...
                  <div class="nothing">
                    <label class="checkbox-inline"><input type="checkbox" disabled="disabled" id="noRegFund1" value="noRegFund1" onclick="clearRegFund('1');">无注册资金</label>
                  </div>
                </dd>
              </dl>
              <dl class="clearfix">
                ...
                <dd>
                  <textarea class="form-control" rows="3" readonly="readonly" maxlength="2000" id="companyDetail1" name="companyDetail1">${companyMyInfo.companyDetail}</textarea>
                </dd>
              </dl>
                <dl class="clearfix">
            ...
            <div class="no_area" id="noArea" style="display:none;">
              <div class="paper clearfix">
                <dl class="clearfix">
                  ...
                  <dd><input type="text" class="form-control" readonly="readonly" maxlength="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="organizationCode" name="organizationCode" value="${companyMyInfo.organizationCode}"></dd>
                </dl>
                <dl class="clearfix">
              ...
              <div class="paper clearfix">
                <dl class="clearfix">
                  ...
                  <dd><input type="text" class="form-control" readonly="readonly" max="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="licenceCode" name="licenceCode" value="${companyMyInfo.licenceCode}"></dd>
                </dl>
                <dl class="clearfix">
                  <dt><span class="red">*</span>注册资金</dt>
                  <dd>
                    <div class="money_input"><input type="text" class="form-control" readonly="readonly" maxlength="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="regFund2" name="regFund2" value="${companyMyInfo.regFund}"></div>
                    <div class="unit">
                      <select class="form-control" id="yuan2" disabled="disabled">
                        <option value="1">元</option>
                        <option value="2">万元</option>
                      </select>
                    </div>
                    <div class="unit">
                      <select class="form-control" id="ut2" disabled="disabled">
                        <option value="1">人民币</option>
                        <!-- <option value="2">美元</option>
                        <option value="3">欧元</option>
                        <option value="4">日元</option>
                    ...
                    <div class="nothing">
                      <label class="checkbox-inline"><input type="checkbox" disabled="disabled" id="noRegFund2" value="noRegFund2" onclick="clearRegFund('2');">无注册资金</label>
                    </div>
                  </dd>
                </dl>
                <dl class="clearfix">
                  <dt><span class="red">*</span>经营范围</dt>
                  <dd>
                    <textarea class="form-control" readonly="readonly" rows="3" maxlength="2000" id="companyDetail2" name="companyDetail2">${companyMyInfo.companyDetail}</textarea>
                  </dd>
                </dl>
                <dl class="clearfix">
                  <dt><span class="red">*</span>营业执照扫描件</dt>
              ...
              <div class="paper clearfix paper_last">
                <dl class="clearfix">
                  ...
                  <dd><input type="text" class="form-control" readonly="readonly" maxlength="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="taxCode" name="taxCode" value="${companyMyInfo.taxCode}"></dd>
                </dl>
                <dl class="clearfix">
        ...
        <div class="section_inner clearfix section_step">
          ...
          <div class="input_area">
            <dl class="clearfix">
              ...
              <dd><input type="text" class="form-control" readonly="readonly" maxlength="100" id="bankName" name="bankName" value="${companyMyInfo.bankName}"></dd>
            </dl>
            <dl class="clearfix">
              <dt><span class="red">*</span>银行基本户账号</dt>
              <dd><input type="text" class="form-control" readonly="readonly" maxlength="50" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="bankCode" name="bankCode" value="${companyMyInfo.bankCode}"></dd>
            </dl>
            <dl class="clearfix">
        ...
        <div class="section_inner clearfix section_step">
          ...
          <div class="input_area">
            <dl class="clearfix">
              <dt>资信等级</dt>
              <dd><input type="text" class="form-control" readonly="readonly" maxlength="100" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" id="quLevel" name="quLevel" value="${companyMyInfo.quLevel}"></dd>
            </dl>
            <dl class="clearfix">
              <dt>资信证书颁发单位</dt>
              <dd><input type="text" class="form-control" readonly="readonly" maxlength="200" id="quCompany" name="quCompany" value="${companyMyInfo.quCompany}"></dd>
            </dl>
            <dl class="clearfix">
              <dt>资信证书扫描件</dt>
              <dd>
              ...
              <dd>
                ...
                <div class="diplay_area" id="showImportAndExportFileDiv" <c:if test="${empty companyMyInfo.importAndExportFileName}"> style="display: none;"</c:if>>
                  ...
                  <!-- <input style="display:none"  type="file" id="importAndExportFileUpload2" name="file" onchange="ajaxFileUpload('7','importAndExportFileUpload2');"> -->
                    ...
                    <!-- <a href="javascript:void(0);" onclick="$('input[id=importAndExportFileUpload2]').click();">修改</a><a href="javascript:void(0);" onclick="delFile('7');">删除</a> -->
                </div>
              </dd>
            </dl>
            <dl class="clearfix">
        ...
        <div class="section_inner clearfix section_step">
          <div class="title">
            <h2><span class="red">*</span>审核意见</h2>
          </div>
          <form action="${pageContext.request.contextPath}/supervise/companyInfo/check" id="checkForm" name="checkForm" method="post">
          	<input type="hidden" id="ifCheck" name="ifCheck" value="${companyMyInfo.checkInfo}"/>
          	<input type="hidden" id="checkInfo" name="checkInfo" value="${companyMyInfo.checkInfo}"/>
          ...
          <div class="input_area">
            <textarea class="form-control suggestion" rows="3" id="checkInfoArea">${companyMyInfo.checkInfo}</textarea>
          </div>
        </div>
        <c:if test="${companyMyInfo.companyType == 2 && (companyMyInfo.ifCheck == 0 || companyMyInfo.ifCheck == 2 || companyMyInfo.ifCheck == 3) && userCount > 0}">
        <div class="section_inner clearfix section_step">
          <div class="title">
            <h2>默认角色</h2>
          </div>
          <div class="input_area role_select">
                
                 <c:forEach items="${roleList}" var="role">
                 <label class="checkbox-inline">
                      <input type="checkbox"  name="isCheck" checked="checked" value="${role.id}"/>${role.roleName}
                 </label>
                 </c:forEach>                               
          </div>
        </div>       
        ...
        <div class="btn_area">
          <button class="btn btn-default gray" type="button" onclick="window.location.href='${pageContext.request.contextPath}/supervise/companyInfo/checkInit?id=${companyMyInfo.id}&flg=${flg}'">返回上一步</button>
          <button class="btn btn-default blue" type="button" onclick="pass();">通过</button>
          <button class="btn btn-default blue" type="button" onclick="refuse();">拒绝</button>
        </div>
      </div>
    </div>
  <!--#contents--></div>
