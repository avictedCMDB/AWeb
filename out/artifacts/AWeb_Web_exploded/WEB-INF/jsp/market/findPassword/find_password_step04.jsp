    ...
    <div class="inner clearfix">
      <div id="step">
          <ul class="image_list clearfix">
            ...
            <li class="selected"><a href="#"><span class="num">3</span><span class="text">设置新密码</span></a></li>
            <li class="selected"><a href="#"><span class="num"><img src="${pageContext.request.contextPath}/static/img/login/icon-finish_white.png"/></span><span class="text">完成</span></a></li>
          </ul>
          <div class="line"></div>
        </div>
        <div class="input_area success_area">
          <p class="success"><span class="img"><img src="${pageContext.request.contextPath}/static/img/order/icon-success.png"/></span><span>新密码设置成功！</span><span>请牢记新密码</span></p>
          <button class="btn blue success" onclick="gotoPage4('${userType}')">直接登录</button>
        </div>
    </div>
  </div>
<!--.page-wrapper--></div>
