...
public interface UserMapper {
    ...
    public List<Role> queryRole(@Param(value="roleId")String roleId);
    ...
    public void defaultUserRole(String companyID,String roleId);
    
    public void deleteDefaultUserRole(String companyID);
