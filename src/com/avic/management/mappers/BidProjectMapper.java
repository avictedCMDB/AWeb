...
public interface BidProjectMapper {
    ...
    public int queryProjectCount(@Param("userId") String userId, @Param("projId") String projId, @Param("projName") String projName, @Param("bidCat") String bidCat, @Param("createTime") String createTime, @Param("status") List<String> status);
    public List<BidProject> queryProjectList(@Param("userId") String userId, @Param("projId") String projId, @Param("projName") String projName, @Param("bidCat") String bidCat, @Param("createTime") String createTime, @Param("status") List<String> status, @Param("order") int order, @Param("start") int start, @Param("end") int end);
