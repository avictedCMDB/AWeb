...
public class Services implements Serializable{
    ...
    private String goodsPriceInit;
    private String supGoodsID;
    
    private String exchangeOrRefound;  //1:换货 2：退货
	...
	public String getExchangeOrRefound() {
		return exchangeOrRefound;
	}
	public void setExchangeOrRefound(String exchangeOrRefound) {
		this.exchangeOrRefound = exchangeOrRefound;
	}
	...
	public String getGoodsPriceInit() {
		return goodsPriceInit;
	}
	public void setGoodsPriceInit(String goodsPriceInit) {
