...
public class TestSDKClient {
    public static String softwareSerialNo = "9SDK-EMY-0999-JDWTP";// 软件序列号,请通过亿美销售人员获取
    public static String key = "852170";// 序列号首次激活时自己设定
    public static String password = "852170";// 密码,请通过亿美销售人员获取
    ...
    public static void testSendSMS() {
        try {
            int i = SingletonClient.getClient(softwareSerialNo,key).sendSMS(new String[] { "15668671907,13478620956,18525308031" }, "【中航技国际经贸发展有限公司】刘强,订单110000有退货申请,请审核!", "",5);// 带扩展码
